...
**[Explore the walkthrough](docs/walkthrough/README.md)** — six recorded scenarios. No installation is required to read it. Recordings use simulated AI and synthetic data. There is no hosted application.

![Requester prepares a complete request; reviewer approves; mock shows receipt without provisioning an account](docs/walkthrough/media/01-successful-request.gif)

[Static poster](docs/walkthrough/media/01-successful-request-poster.png)
...
## Portfolio walkthrough (GitHub Markdown)

Recruiter-facing path: [`docs/walkthrough/README.md`](docs/walkthrough/README.md). GIFs are from the **local** app with fake LLM/embeddings. Provenance: [`docs/walkthrough/media/provenance.md`](docs/walkthrough/media/provenance.md). This presentation **replaces public deployment**. Do not expect a Vercel/Render/Neon/Azure/GitHub Pages visitor workspace.

**Maturity of what you are looking at**

| Claim | Status |
| --- | --- |
| Local simulated workflow in these recordings | **Demonstrated** (fake LLM/embeddings, synthetic data) |
| Azure OpenAI adapter | **Implemented**; **tested with mocked Azure responses** |
| Real Azure calls and managed identity | **Not verified** by these recordings |
| Hosted application | **Not provided** |

Fake-provider evaluation numbers (below) are **not** real-model quality. There are no committed Ollama evaluation results. No time savings are claimed.

Spoken 3–5 min local script: [`docs/demo-script.md`](docs/demo-script.md). Capture commands: [`docs/walkthrough/recording.md`](docs/walkthrough/recording.md).
...
| Recruiter walkthrough (`docs/walkthrough/`) | **Documented** with local GIFs ([landing page](docs/walkthrough/README.md)) |
| Cloud deploy / paid APIs / public visitor host | **Not used** — walkthrough replaces public deployment |
...
| [`docs/walkthrough/`](docs/walkthrough/README.md) | Recruiter Markdown walkthrough and GIF recording plan |
